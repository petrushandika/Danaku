  ...
  id: {
    ...
    dashboard: {
      budgeting: {
        ...
        remaining: "Sisa Dialokasikan",
        totalProjected: "Total Proyeksi",
        needs: "Kebutuhan",
        wants: "Keinginan",
        savingsCat: "Tabungan",
        noSetup: "Tidak ada item di Setup.",
        loadingBudget: "Memuat rencana anggaran...",
        createPlanDesc:
          'Klik "Buat Rencana" di atas untuk memulai perjalanan finansial Anda bulan ini.',
      },
      markAllRead: "Tandai semua sudah dibaca",
      summary: {
        ...
        badgeIncome: "Pemasukan",
        badgeSpending: "Pengeluaran",
        badgeSavings: "Tabungan",
        badgeAsset: "Aset",
        badgeBudget: "Anggaran",
      },
      spending: {
      ...
      setup: {
        ...
        typeLabels: {
          account: "Akun (Dompet/Bank)",
          income: "Sumber Pendapatan",
          needs: "Kebutuhan (Tetap)",
          wants: "Keinginan (Fleksibel)",
          savings: "Tabungan / Investasi",
          assets: "Aset",
        },
        placeholder: {
          selectMonth: "Pilih bulan",
          noItems: "Belum ada item. Tambah item pertama Anda di bawah!",
          newItem: "Nama Item Baru",
          enterName: "Masukkan nama",
          addCustom: "Tambah item kustom",
          activeItems: "Item Aktif",
          settings: "Pengaturan",
          manage: "Kelola daftar dan konfigurasi",
        },
      },
      nav: {
        summary: "Ringkasan",
      ...
      profile: {
        ...
        display: {
          ...
          appearance: "Tampilan",
          appearanceDesc: "Pilih antara mode terang atau gelap.",
          theme: "Tema",
  ...
  en: {
    ...
    dashboard: {
      budgeting: {
        ...
        wants: "Wants",
        savingsCat: "Savings",
        noSetup: "No items configured in Setup.",
        loadingBudget: "Loading budget plan...",
        createPlanDesc:
          'Click "Create Plan" above to start your financial journey for this month.',
      },
      markAllRead: "Mark all as read",
      summary: {
        ...
        badgeIncome: "Income",
        badgeSpending: "Spending",
        badgeSavings: "Savings",
        badgeAsset: "Asset",
        badgeBudget: "Budgeting",
      },
      spending: {
      ...
      setup: {
        ...
        placeholder: {
          ...
          noItems: "No items yet. Add your first item below!",
          newItem: "New Item Name",
          enterName: "Enter name",
          addCustom: "Add custom item",
          activeItems: "Active Items",
          settings: "Settings",
          manage: "Manage your list and configurations",
        },
      },
      nav: {
        summary: "Summary",
      ...
      profile: {
        ...
        display: {
          ...
          appearanceDesc: "Choose between light or dark mode.",
          theme: "Theme",
