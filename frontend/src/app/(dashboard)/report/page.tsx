...
const barData = [
  ...
  { name: "Food", budget: 4000000, actual: 4200000 },
  { name: "Transp.", budget: 1500000, actual: 1200000 },
  { name: "Ent.", budget: 1000000, actual: 1400000 },
  { name: "Bills", budget: 800000, actual: 800000 },
]

const pieData = [
  { name: "Needs", value: 5400000, color: "#10b981" },
  { name: "Wants", value: 3200000, color: "#6366f1" },
  { name: "Savings", value: 4500000, color: "#ec4899" },
  { name: "Investment", value: 1500000, color: "#f59e0b" },
]
        ...
        <Card className="border-border shadow-none rounded-3xl bg-white dark:bg-slate-900 overflow-hidden border group transition-all hover:border-slate-400 dark:hover:border-slate-600">
          <CardHeader className="p-6 md:px-10 md:pt-8 md:pb-4">
            <div className="flex items-center gap-5 mb-2">
              ...
              <div>
                <CardTitle className="text-2xl font-bold text-slate-800 dark:text-white">{t.analysisTitle}</CardTitle>
                <CardDescription className="text-slate-500 dark:text-slate-400 font-medium">{t.analysisDesc}</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6 md:px-10 md:pb-8 pt-0">
             ...
             <Button variant="ghost" className="w-full mt-8 rounded-2xl group/btn py-6 font-bold text-slate-600 dark:text-slate-400 border border-transparent hover:border-slate-100 dark:hover:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer">
                {t.detailedBtn} <ArrowRight className="ml-2 w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
             </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-border shadow-none rounded-3xl bg-white dark:bg-slate-900 overflow-hidden border group transition-all hover:border-slate-400 dark:hover:border-slate-600">
          <CardHeader className="p-6 md:px-10 md:pt-8 md:pb-4">
            <div className="flex items-center gap-5 mb-2">
              ...
              <div>
                <CardTitle className="text-2xl font-bold text-slate-800 dark:text-white">{t.distTitle}</CardTitle>
                <CardDescription className="text-slate-500 dark:text-slate-400 font-medium">{t.distDesc}</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6 md:px-10 md:pb-8 pt-0">
             ...
             <Button variant="ghost" className="w-full mt-8 rounded-2xl group/btn py-6 font-bold text-slate-600 dark:text-slate-400 border border-transparent hover:border-slate-100 dark:hover:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer">
                {t.optimizeBtn} <ArrowRight className="ml-2 w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
             </Button>
          </CardContent>
        </Card>
      </div>
        ...
        trigger={
          <Card className="border-indigo-700 dark:border-indigo-800 rounded-3xl bg-linear-to-r from-indigo-600 to-violet-700 dark:from-indigo-800 dark:to-indigo-950 p-8 md:p-12 text-white overflow-hidden relative border shadow-sm cursor-pointer group hover:shadow-xl transition-all">
             ...
             <div className="relative z-10 max-w-2xl">
                <h2 className="text-3xl font-black mb-5 tracking-tight group-hover:translate-x-1 transition-transform">{t.aiTitle}</h2>
                <p 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                <p className="text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 mb-1">Potential Savings</p>
                <p className="text-lg font-bold text-emerald-600 dark:text-emerald-400">Rp 1.2M / mo</p>
             </div>
             <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                <p className="text-[10px] font-black uppercase text-slate-400 dark:text-slate-500 mb-1">Advice Type</p>
                <p className="text-lg font-bold text-indigo-600 dark:text-indigo-400">Lifestyle</p>
             </div>
          </div>
          <Button 
