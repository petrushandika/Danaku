            ...
            <div className="flex items-center gap-3">
              ...
              <span className="capitalize">
                {activeTab === "personal"
                  ? t.personalInfo
                  : activeTab === "security"
                  ? t.security?.title.replace(/<\/?[^>]+(>|$)/g, "") ||
                    "Security"
                  : activeTab === "achievements"
                  ? t.achievements?.title.replace(/<\/?[^>]+(>|$)/g, "") ||
                    "Achievements"
                  : activeTab === "family"
                  ? t.family?.title.replace(/<\/?[^>]+(>|$)/g, "") || "Family"
                  : activeTab === "notifications"
          ...
          <SelectContent className="rounded-2xl border-border shadow-xl bg-white dark:bg-slate-900 overflow-hidden p-1 max-h-[40vh] overflow-y-auto">
            {[
              ...
              <SelectItem
                key={item.id}
                value={item.id}
                className="rounded-xl my-1 py-3 px-3 cursor-pointer focus:bg-slate-50 dark:focus:bg-slate-800 focus:text-emerald-600 font-bold text-slate-500 dark:text-slate-400"
              >
                <div className="flex items-center gap-3">
          ...
          <Card className="border-border bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-sm transition-all duration-300">
            <CardContent className="p-4 space-y-1">
              ...
              <TabButton
                ...
                icon={Lock}
                label={
                  t.security?.title.replace(/<\/?[^>]+(>|$)/g, "") || "Security"
                }
              />
              <TabButton
                id="achievements"
          ...
          <Card className="border-border bg-white dark:bg-slate-900 rounded-3xl lg:rounded-[2.5rem] overflow-hidden shadow-sm transition-all duration-300">
                ...
                <div className="text-center md:text-left space-y-1">
                  ...
                  <label htmlFor="avatar-upload">
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="mt-4 rounded-full border-border font-bold transition-all duration-300 hover:shadow-sm cursor-pointer"
                    >
            ...
            <CardContent className="p-6 md:p-8 space-y-8">
              ...
              {activeTab === "personal" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-right-4 duration-500">
                  <div className="space-y-2">
                    <Label className="font-bold text-slate-700 dark:text-slate-300 ml-1 transition-colors duration-300">
                      {t.fullName}
                    </Label>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-slate-500 font-bold ml-1 italic transition-colors duration-300">
                      *{" "}
                      {language === "id"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <Label className="font-bold text-slate-700 dark:text-slate-300 ml-1">
                          {t.security?.currentPwd}
                        </Label>
                        <PasswordInput
                      ...
                      <div className="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/30">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="space-y-1">
                            <h4 className="font-black text-emerald-900 dark:text-emerald-400">
                              {t.security?.twoFactor}
                            </h4>
                            <p className="text-sm font-medium text-emerald-700 dark:text-emerald-500 pr-4">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        state: marketingNotif,
                        set: setMarketingNotif,
                      },
                    ].map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center justify-between p-4 rounded-2xl border border-border bg-slate-50/30 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                      >
                        <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between pb-2 border-b border-border">
                    <h3
                      ...
                      dangerouslySetInnerHTML={{
                        __html: t.achievements?.title || "Achievements",
                      }}
                    />
                    ...
                    <div className="relative z-10 flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-black">
                          Financial Guru <span className="text-2xl">ign</span>
                        </h2>
                      </div>
              ...
              {activeTab === "family" && (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        relation: "Son",
                        avatar:
                          "https://images.unsplash.com/photo-1540479859555-17af45c78602?auto=format&fit=crop&w=100&h=100&q=80",
                        limit: "Rp 2.500.000",
                      },
                    ].map((member, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-3xl border border-border shadow-sm hover:border-emerald-500/30 transition-all duration-300 group gap-4"
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0">
                            <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 truncate text-sm sm:text-base">
                              {member.name}
                              {idx === 0 && (
                                <span className="bg-emerald-100 text-emerald-700 text-[10px] px-2 py-0.5 rounded-full uppercase tracking-wider font-extrabold border border-emerald-200 shrink-0">
                                  Owner
                                </span>
                              )}
                            </h4>
                  ...
                  <div className="bg-blue-50 dark:bg-indigo-900/10 p-5 rounded-2xl border border-blue-100 dark:border-indigo-900/30 flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-blue-900 dark:text-indigo-300 text-sm mb-1">
                        Multi-Generational SafeGuard
                      </h4>
                      <p className="text-xs text-blue-700 dark:text-indigo-400 leading-relaxed font-medium">
                        Create dedicated financial buffers for your elderly
                        parents and children. Ensure your personal retirement
                        savings remain untouched while caring for your loved
                        ones.
                      </p>
                    </div>
                  </div>
              ...
              <div className="pt-8 border-t border-border flex justify-end gap-4">
                <Button
                  variant="ghost"
                  className="rounded-2xl h-12 px-8 font-black text-slate-500 transition-all duration-300"
                >
                  {t.cancelBtn}
                </Button>
                <Button
