          ...
          <main className="lg:col-span-8 xl:col-span-9">
            ...
            <div className="mt-8 p-6 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800">
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                {language === "id"
                  ? "Jika Anda memiliki pertanyaan tentang Syarat Ketentuan ini, silakan hubungi kami di support@danaku.com"
                  : "If you have any questions about these Terms, please contact us at support@danaku.com"}
              </p>
            </div>
          </main>
        </div>
