...
const FacebookIcon = () => (
  ...
  >
    <path
      d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.023 4.412 11.014 10.125 11.91V15.53H7.078v-3.457h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.457h-2.796v8.455C19.588 23.087 24 18.096 24 12.073z"
      fill="#1877F2"
    />
  </svg>
);
