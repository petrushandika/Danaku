  ...
  return (
    <div className="w-full">
        ...
        <CardContent className="p-6 md:p-8">
          ...
          <div className="mt-6 text-center pt-4 border-t border-slate-50">
            <p className="text-sm font-medium text-slate-500">
              Already have an account? <Link href="/auth/login" className="text-emerald-600 font-bold hover:underline underline-offset-4">Login</Link>
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="mt-6 flex items-center justify-center gap-3 opacity-60">
         ...
         <span className="text-xs font-bold text-slate-400">Data Privacy Policy Guaranteed</span>
      </div>
    </div>
  )
}
